...
# 6. Logarithmic transformation of skewed variables 
...
# 8. Encode Status in a dummy
scaled_lifeexp$Status <- ifelse(life_expectancy_dataset$Status == "Developed", 1, 0)

# 9. Handle multicollinearity: drop highly correlated variables
